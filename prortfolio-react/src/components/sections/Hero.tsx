...
export default function Hero() {
  ...
  const socialLinks = [
    { icon: FaGithub, href: settings?.github || "https://github.com", color: "hover:text-white" },
    { icon: FaLinkedinIn, href: settings?.linkedin || "https://linkedin.com", color: "hover:text-blue-400" },
    { icon: FaWhatsapp, href: `https://wa.me/${settings?.phone || "+201120354592"}`, color: "hover:text-green-500" },
    { icon: FaTwitter, href: settings?.twitter || "#", color: "hover:text-sky-400" },
  ];
