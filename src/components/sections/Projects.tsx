            ...
            <div className="p-8 flex flex-col flex-grow">
              ...
              <div className="flex flex-col gap-3">
                <a 
                  ...
                  className="w-full flex items-center justify-center gap-2 py-4 rounded-xl bg-purple-600 text-white text-sm font-black hover:bg-purple-700 transition-all shadow-xl shadow-purple-600/20 uppercase tracking-widest"
                >
                ...
                <div className="flex items-center gap-3">
                  <a 
                    ...
                    className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl bg-[var(--bg-alt)] border border-[var(--border-main)] text-xs font-bold text-[var(--text-main)] hover:bg-[var(--bg-card)] transition-all"
                  >
